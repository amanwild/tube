...
class Scraper:
    def __init__(self):
        ...
        chrome_options.add_argument={"C:/Users/amans/AppData/Local/Google/Chrome/User Data/Profile 1"}
        self.driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()),options=chrome_options)
        # chrome_options.add_argument("C:/amans/amans/~/Library/Application Support/Google/Chrome/Default/Network/Cookies")
...
# o.add_argument = {'C:/Users/amans/AppData/Local/Google/Chrome/User Data/Profile 1'}
# #set chromedriver.exe path
# driver = webdriver.Chrome(executable_path="C:/Program Files/Google/Chrome/Application/chrome.exe", options=o)
# #maximize browser
